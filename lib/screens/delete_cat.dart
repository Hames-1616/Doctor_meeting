...
import 'package:project/utils/expert_d.dart';
import 'package:project/utils/expert_view.dart';

import '../utils/expert2.dart';

class delcat extends StatefulWidget {
  const delcat({super.key});

  @override
  State<delcat> createState() => _delcatState();
}

class _delcatState extends State<delcat> {
  bool empty = true;
